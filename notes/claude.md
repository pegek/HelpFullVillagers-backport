...
| 6 | Inventory + Container | ⬜ | ItemStack.EMPTY semantics |
| 7 | Crafting + Economy | ⬜ | CraftingManager.REGISTRY iteracja |
| 8 | Village system + WorldSavedData + CommonHooks events | ⬜ | writeToNBT RETURNS NBTTagCompound |
| 9 | GUI (8 ekranów + GuiHandler) | ⬜ | button objects, I18n |
