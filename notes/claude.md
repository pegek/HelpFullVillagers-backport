...
| 11 | Renderers + ClientProxy registration (IRenderFactory) | ✅ | RenderVillagerCustom extends RenderBiped<AbstractVillager>(renderManager,ModelBiped,0.5f); getEntityTexture per profession; 10 registerEntityRenderingHandler; RenderFishHookCustom stub |
...
| 14 | Full build + reobf jar → user smoke test | 🔄 | Build SUCCESSFUL. Gotowy do testów — czeka na grę. Pozostało: pełne 8 GUI + pełny fish hook |
